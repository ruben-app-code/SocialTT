<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('following.index') }}" :active="request()->routeIs('following.*')">
                        {{ __('Siguiendo') }}
                    </x-nav-link>
                    ...
                    <x-nav-link href="{{ route('lang.index') }}" :active="request()->routeIs('lang.*')">
                        {{ __('Traducciones') }}
                    </x-nav-link>
            ...
            <div class="flex items-center gap-1.5 sm:gap-2 shrink-0 ms-2 sm:ms-4">
                <button
                    type="button"
                    class="inline-flex items-center justify-center rounded-full p-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 dark:focus:ring-offset-gray-800 transition"
                    title="{{ __('Pantalla completa (pulse de nuevo para salir)') }}"
                    aria-label="{{ __('Alternar pantalla completa') }}"
                    @click="
                        (function () {
                            var d = document;
                            var fs = d.fullscreenElement || d.webkitFullscreenElement || d.msFullscreenElement;
                            if (fs) {
                    ...
                    "
                >
                    <svg class="size-5 sm:size-6 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <x-appearance-switch compact class="hidden sm:inline-flex" />
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('configuration.show') }}" class="!flex w-full items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 shrink-0 text-gray-500 dark:text-gray-400">
                ...
                <!-- Hamburger (móvil: junto al interruptor de tema) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('following.index') }}" :active="request()->routeIs('following.*')">
                {{ __('Siguiendo') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link href="{{ route('lang.index') }}" :active="request()->routeIs('lang.*')">
                {{ __('Traducciones') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link href="{{ route('configuration.show') }}" :active="request()->routeIs('configuration.*')" class="!flex items-center gap-2">
