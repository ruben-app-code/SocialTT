...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset("/assets-blue") }}/imgs/template/favicon.svg">
    <link href="{{ asset("/assets-blue") }}/css/style.css?v=2.0" rel="stylesheet">
...
<div id="preloader-active">
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            <div class="text-center"><img class="mb-10" src="{{ asset("/assets-blue") }}/imgs/template/favicon.svg" alt="GenZ">
    ...
    <div class="container">
        <div class="main-header">
            <div class="header-logo"><a class="d-flex" href="index.html"><img class="logo-night" alt="GenZ"
                                                                              src="{{ asset("/assets-blue") }}/imgs/template/logo.svg"><img class="d-none logo-day" alt="GenZ"
                                                                                                                       src="{{ asset("/assets-blue") }}/imgs/template/logo-day.svg"></a></div>
            ...
            <div class="perfect-scroll">
                ...
                <div class="mobile-account border-gray-800">
                    <div class="mobile-header-top bg-gray-900">
                        <div class="user-account"><a href="page-login.html"><img src="{{ asset("/assets-blue") }}/imgs/template/ava.jpg"
                                                                                 alt="GenZ"></a>
                            <div class="content">
                ...
                <div class="col-xl-10 col-lg-12">
                    <div class="banner banner-home2">
                        ...
                        <div class="text-center mt-0">
                            <h4 class="color-linear mb-10">Temas</h4>
                            <p class="text-lg color-gray-500">Discover the most outstanding artizzcles in all topics</p>
                        </div>


                        <div class="text-center mt-20">
                            @foreach($topics as $topic)
                                <a class="btn btn-tag bg-gray-800 hover-up mb-10 text-xs"
                                   href="{{ url('explore?topic='.$topic->slug) }}">{{ $topic->name }}</a>
                            @endforeach
                        </div>

                        <div class="text-center mt-40">
                            <h4 class="color-linear mb-10">Usuarios</h4>
                            <p class="text-lg color-gray-500">Discover the most outstanding articles in all topics</p>
                        </div>



                        <ul class="list-tags-col-5 mt-20 mb-50 text-center">

                            @foreach($creators as $creator)
                            <li>
                                <div class="card-style-2 hover-up hover-neon wow animate__animated animate__fadeInUp"
                                     data-wow-delay="0s">
                                    <div class="card-image"><img src="{{ asset( $creator->profile_photo_path) }}" alt="{{ $creator->name }}"></a>
                                    </div>
                                    <div class="card-info">
                                        <a class="color-gray-500" href="{{ $creator->creator_profile_url }}">{{ $creator->name }}</a>
                                    </div>
                                </div>
                            </li>
                            @endforeach
        ...
        <div class="footer-1 bg-gray-850 border-gray-800">
            <div class="row">
                <div class="col-lg-4 mb-30"><a class="wow animate__animated animate__fadeInUp" href="index.html"><img
                            class="logo-night" src="{{ asset("/assets-blue") }}/imgs/template/logo.svg" alt="Genz"><img class="d-none logo-day"
                                                                                                   alt="GenZ" src="{{ asset("/assets-blue") }}/imgs/template/logo-day.svg"></a>
                    <p class="mb-20 mt-20 text-sm color-gray-500 wow animate__animated animate__fadeInUp">When an unknown prnoto
                        sans took a galley and scrambled it to make specimen book not only five When an unknown prnoto sans took a
                        galley and scrambled it to five centurie.</p>
                    <h6 class="color-white mb-5 wow animate__animated animate__fadeInUp">Address</h6>
                    <p class="text-sm color-gray-500 wow animate__animated animate__fadeInUp">123 Main Street<br>New York, NY
                        10001</p>
                </div>
                        ...
                        <div class="col-6">
                            <ul class="menu-footer">
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Action</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Business</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Adventure</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Canada</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">America</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Curiosity</a></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul class="menu-footer">
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Animal</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Dental</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Biology</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Design</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Breakfast</a></li>
                                <li class="wow animate__animated animate__fadeInUp"><a class="color-gray-500"
                                                                                       href="blog-archive.html">Dessert</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-30">
                    ...
                    <p class="text-base color-gray-500 wow animate__animated animate__fadeInUp">Sign up to be first to receive
                        the latest stories inspiring us, case studies, and industry news.</p>
                ...
                <div class="row">
                    <div class="col-lg-5 text-center text-lg-start">
                        <p class="text-base color-white wow animate__animated animate__fadeIn">© Created by<a class="copyright"
                                                                                                              href="http://alithemes.com" target="_blank"> AliThemes.com</a></p>
                    </div>
...
<script src="{{ asset("/assets-blue") }}/js/vendors/modernizr-3.6.0.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/jquery-3.6.0.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/jquery-migrate-3.3.0.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/bootstrap.bundle.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/waypoints.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/wow.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/text-type.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/swiper-bundle.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/vendors/jquery.progressScroll.min.js"></script>
<script src="{{ asset("/assets-blue") }}/js/main.js?v=2.0"></script>
</body>
